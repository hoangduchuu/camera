...
import com.example.hoang.myhkview.DvrCameraSurfaceView;
...
//    }
     ...
     */
//    public void capture(){
//        userId = hcNetSdk.NET_DVR_CaptureJPEGPicture_NEW()
//    }
    ...
    public String login() {
        ...
        userId = hcNetSdk.NET_DVR_Login_V30(DVR_IP, DVR_PORT, "redbean", "Redbean2017", dvrInfo);
...
//    };
    ...
    private int SizeOfJPEGByteArray (byte[] data)
    {
        //boolean found = false;
        for(int i = 0; i < data.length; ++i)
        {
            if (data[i] == (byte)(0xFF)) { //return i;
                if (data[i + 1] == (byte)(0xD9)) return i;
            }
        }
        return -1;
    }
